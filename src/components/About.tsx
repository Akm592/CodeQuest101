...
const AboutPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-950 text-muted-foreground overflow-x-hidden relative w-screen flex flex-col">
      {/* Header */}
      ...
      <main className="flex-grow relative z-10">
          ...
          <div className="absolute inset-0 overflow-hidden opacity-10 z-0"> {/* Reduced opacity, check blend mode */}
            ...
            <div className="absolute top-1/3 right-0 w-96 h-96 bg-primary/15 rounded-full filter blur-3xl translate-x-24 mix-blend-screen"></div>
        ...
        <div className="container mx-auto px-4 pt-16 pb-24 relative z-10"> {/* Add padding top below header */}
          ...
          <div className={`text-center mb-16 transition-all duration-1000 ease-out transform ${animateHeader ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <h1 className="text-5xl font-bold text-foreground mb-4">
              CodeQuest<span className="text-primary">101</span> {/* Accent color */}
            </h1>
          ...
          {/* Vision Section */}
          <section className="bg-gray-900 rounded-xl shadow-lg ring-1 ring-gray-700/50 p-8 mb-12 transform transition hover:shadow-primary/20 duration-300 hover:-translate-y-1">
            <h2 className="text-3xl font-bold text-foreground mb-6 flex items-center">
              <BookOpen className="mr-3 text-primary" size={28} /> {/* Accent color */}
              Our Vision
            </h2>
          ...
          <section className="mb-12 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-lg ring-1 ring-primary/30 p-8 text-foreground transform transition hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/20 duration-300">
              <h3 className="text-2xl font-bold mb-4 flex items-center text-foreground">
                <Code className="mr-3 text-primary" size={24} /> {/* Accent color */}
          ...
          <section className="bg-gray-900 rounded-xl shadow-lg ring-1 ring-gray-700/50 p-8 mb-12 transform transition hover:shadow-indigo-900/30 duration-300 hover:-translate-y-1">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              <div className="flex-shrink-0">
                ...
                <div className="w-40 h-40 md:w-48 md:h-48 mx-auto bg-gradient-to-br from-primary to-indigo-700 rounded-full flex items-center justify-center text-white text-5xl font-bold ring-4 ring-gray-700 shadow-lg">
                  AM
                </div>
              </div>
              <div className="flex-grow text-center md:text-left">
                <h3 className="text-2xl font-semibold text-foreground mb-1">Ashish Kumar Mishra</h3>
                <p className="text-primary mb-1">Creator & Lead Developer</p>
                <p className="text-muted-foreground text-sm mb-4">BTech, Information Technology</p>
                ...
                <div className="flex gap-4 justify-center md:justify-start">
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-sm text-primary hover:text-primary hover:underline transition-colors"
                  >
          ...
          {/* Open Source Section */}
          <section className="bg-gradient-to-br from-gray-900 to-black rounded-xl shadow-xl ring-1 ring-gray-700 p-8 mb-12 text-foreground transform transition hover:shadow-lg hover:shadow-gray-800/40 duration-300">
          ...
          <section className="text-center mt-16">
            <h2 className="text-3xl font-bold text-foreground mb-6">Begin Your CodeQuest Today</h2>
