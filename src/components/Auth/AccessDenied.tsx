    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] bg-gray-950 text-muted-foreground p-4 w-screen"> {/* Adjusted height and added bg */}
      <div className="text-center max-w-md">
          ...
          <Link to="/login">
            ...
            <button className="bg-primary hover:bg-primary text-white px-8 py-2.5 rounded-lg text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-gray-950">
              Go to Sign In
            </button>
          </Link>
      </div>
