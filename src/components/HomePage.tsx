...
const categories = [
  {
    ...
    icon: <AlignJustify className="h-12 w-12 text-primary" />,
    key: "algorithms",
  },
  {
            ...
            {!selectedCategory ? (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {categories.map((category) => (
                  <Card
                    key={category.key}
                    className="hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 bg-card cursor-pointer"
              ...
              <>
                <button
                  ...
                  className="mb-6 bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded-md transition-colors duration-200"
                >
                  Back to Categories
                </button>
